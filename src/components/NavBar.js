...
export class NavBar extends Component {
  ...
  <div className="container-fluid ">
    ...
    <img  src="moon.png" alt="Moon" onClick={darktheme} className='darkimg2'  height={45} width={45} style={{cursor:"pointer",marginLeft:"30px"}}/>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <img  src="moon.png" alt="Moon" onClick={darktheme} id="darkimg" height={45} width={45} style={{cursor:"pointer",marginLeft:"30px"}}/>
